//This is for the new request data table, 
  ...
  $(document).ready(function() {
    ...
    $('#example').DataTable( {
        ...
        columns: [
            ...
            { title: "City" },
            { title: "Start date" },
            { title: "design his/her test" }
        ],
        "columnDefs": [ {
            "targets": -1,
            "data": null,
            "defaultContent": "<button> Click to design test!!!</button>"
        } ]
    } );
    //Draw the new table
    ...
    $('#example tbody').on( 'click', 'button', function () {
        ...
        alert("data of this cell can be sent for back-end function which is as follows\n"+ "Name: " + data[0] +"\n"+"UserType:" + data[1] +"\n"+ "College: " + data[2] + "\n" + "City: "+ data[3])
    } );
